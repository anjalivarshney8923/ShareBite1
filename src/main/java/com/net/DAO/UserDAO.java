    ...
    public static int login(UserBean ub) {
        ...
        try {
            ...
            try (Connection con = DriverManager.getConnection(url, username, password);
                 PreparedStatement ps = con.prepareStatement("SELECT * FROM users WHERE email=? AND password=? AND isActive=1")) {
        ...
        try {
            ...
            try (Connection con = DriverManager.getConnection(url, username, password);
                 PreparedStatement ps = con.prepareStatement(
                    "INSERT INTO users (name, email, password, role, organizationName, phone, city, createdAt, isActive, organizationType, donationFrequency) VALUES (?, ?, ?, ?, ?, ?, ?, NOW(), ?, ?, ?)")) {
                ps.setString(1, name);
                ...
                ps.setString(9, ub.getOrganizationType());
                ps.setString(10, ub.getDonationFrequency());
