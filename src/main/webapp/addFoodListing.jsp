    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="addFoodListingProcess.jsp" method="post" enctype="multipart/form-data" id="foodListingForm">
                ...
                <!-- Pickup Information with Google Maps -->
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="pickupZipCode" name="pickupZipCode" required>
                        </div>
    ...
    <script>
        ...
        function initMap() {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                if (place.geometry) {
                    ...
                    updateAddressFromCoordinates(place.geometry.location);
        ...
        function placeMarker(latLng) {
            ...
            marker.addListener('dragend', function() {
                updateAddressFromCoordinates(marker.getPosition());
            });
        ...
        // Fill address fields from place result
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        map.setZoom(15);
                        placeMarker(pos);
                        updateAddressFromCoordinates(pos);
                    },
                    function() {
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML = `<img src="${e.target.result}" alt="Food Image Preview">`;
                };
                reader.readAsDataURL(input.files[0]);
            } else {
                preview.innerHTML = `<p class="text-muted">Upload an image to help NGOs better understand the food items</p>`;
            }
        }
